...
\begin{DoxyCode}
46     \{
47         \textcolor{keywordflow}{return} M\_dofPressure [ component ];
48     \} \textcolor{comment}{// getDOFPressure}
\end{DoxyCode}
...
\begin{DoxyCode}
52     \{
53         \textcolor{keywordflow}{return} M\_dofVelocity [ component ] [ region ];
54     \} \textcolor{comment}{//  getDOFVelocity}
\end{DoxyCode}
...
\begin{DoxyCode}
58     \{
59         \textcolor{keywordflow}{return} M\_dofVelocity [ region ];
60     \} \textcolor{comment}{// getDOFVelocity}
\end{DoxyCode}
...
\begin{DoxyCode}
82     \{
83         \textcolor{keywordflow}{return} M\_elementID;
84     \} \textcolor{comment}{// getElementID}
\end{DoxyCode}
...
\begin{DoxyCode}
70     \{
71         \textcolor{keywordflow}{return} M\_fractures [ f ];
72     \} \textcolor{comment}{// getFracture}
\end{DoxyCode}
...
\begin{DoxyCode}
64     \{
65         \textcolor{keywordflow}{return} M\_fractures;
66     \} \textcolor{comment}{// getFractures}
\end{DoxyCode}
...
\begin{DoxyCode}
76     \{
77         \textcolor{keywordflow}{return} M\_fractures.size();
78     \} \textcolor{comment}{// getNumFractures}
\end{DoxyCode}
...
\begin{DoxyCode}
39     \{
40         M\_dofPressure = dofPressure;
41         M\_dofVelocity = dofVelocity;
42     \} \textcolor{comment}{// setDofPosition}
\end{DoxyCode}
