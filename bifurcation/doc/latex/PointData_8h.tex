...
Grafo delle dipendenze di inclusione per Point\-Data.\-h\-:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{PointData_8h__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{PointData_8h__dep__incl}
\end{center}
\end{figure}
\subsection*{Composti}
