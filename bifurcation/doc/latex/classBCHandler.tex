...
116             \{
117                 \textcolor{keywordflow}{if} ( M\_dirichletCut [ f ].size() <= 0 )
118                 \{
119                     M\_dirichletCut [ f ].push\_back(\hyperlink{classBCHandler_a2bc86209db0836dbc6ca56e1ca4e4ac1a57ea96455b2ba998cc42a21aa7e1d842}{DIRICHLET\_BOUNDARY\_CUT} + f);
120                 \}
121                 \textcolor{keywordflow}{for} ( size\_type jj = 0; jj < 3; ++jj )
122                 \{
123                     \textcolor{keywordflow}{if} ( meshRegionDirichlet.is\_in(i\_cv, jj) )
124                     \{
125                         mesh.region(M\_dirichletCut [ f ] [ 0 ]).add(i\_cv, jj);
126                         mesh.region(M\_dirichletUncut [ 0 ]).sup(i\_cv, jj);
127                     \}
128                 \}
129             \}
130         \}
...
135 \}\textcolor{comment}{// createBDRegionsFractures}
\end{DoxyCode}
