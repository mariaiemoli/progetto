...
\begin{DoxyCompactList}\small\item\em Funzione che retituisce l'insieme di tutte le intersezioni. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Funzione che retituisce l'insieme di tutte le intersezioni. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCode}
7                            :
8 M\_intersections ( \textcolor{keyword}{new} \hyperlink{classFractureIntersect}{FractureIntersect\_Type} )
9 \{
10 \}\textcolor{comment}{// costruttore nullo}
\end{DoxyCode}
...
{\em size\-\_\-type\&} & f\-: id della frattura che mi interessa \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Restituisce}
Fracture\-Handler\-Ptr\-\_\-\-Type\& M\-\_\-fractures\mbox{[}f\mbox{]}\-: frattura di indice \char`\"{} f \char`\"{} nell'insieme delle fratture 
\end{DoxyReturn}

\begin{DoxyCode}
53     \{
54             \textcolor{keywordflow}{return} M\_fractures[f];
55     \}
\end{DoxyCode}
...
\begin{DoxyCode}
64     \{
65             \textcolor{keywordflow}{return} M\_fractures[f];
66     \}
\end{DoxyCode}
...
\begin{DoxyReturn}{Restituisce}
Fracture\-Intersect\-Ptr\-\_\-\-Type\& M\-\_\-intersections\-: puntatore alla classe delle intersezioni 
\end{DoxyReturn}

\begin{DoxyCode}
74     \{
75             \textcolor{keywordflow}{return} M\_intersections;
76     \}
\end{DoxyCode}
...
\begin{DoxyCode}
85     \{
86             \textcolor{keywordflow}{return} M\_intersections;
87     \}
\end{DoxyCode}
...
\begin{DoxyCode}
42     \{
43             \textcolor{keywordflow}{return} M\_fractures.size();
44     \}
\end{DoxyCode}
