...
\begin{DoxyCode}
7                                                                       :
8                     M\_vtkFolder(dataFile((section + \textcolor{stringliteral}{"folderVTK"}).data(), \textcolor{stringliteral}{"./vtk/"}))
9 \{
10 \}\textcolor{comment}{// costruttore}
\end{DoxyCode}
...
\begin{center}
\leavevmode
\includegraphics[width=348pt]{classExporter_af02a2344019769ab23d9ac673a7b3709_cgraph}
\end{center}
\end{figure}
...
\begin{DoxyCode}
14 \{
15     gmm::MatrixMarket\_IO::write(nameFile.c\_str(), *matrix);
16 
17     \textcolor{keywordflow}{return};
18     
19 \} \textcolor{comment}{// spy}
\end{DoxyCode}
