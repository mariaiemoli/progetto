...
{\em medium\-Mesh} & mesh di supporto del mezzo \\
\hline
{\em medium\-Integration\-Type\-Velocity} & metodo di integrazione per la velocità \\
\hline
{\em medium\-Mesh\-F\-E\-M\-Pressure} & mesh di integrazione per la pressione \\
\hline
{\em medium\-Mesh\-F\-E\-M\-Velocity} & mesh di integrazione per la velocità \\
\hline
\end{DoxyParams}
